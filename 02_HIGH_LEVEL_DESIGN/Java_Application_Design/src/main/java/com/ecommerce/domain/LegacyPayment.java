...
public class LegacyPayment {
    ...
    public LegacyPayment(String orderId, String userId, BigDecimal amount, PaymentMethod method) {
    ...
    public LegacyPayment(String id, String orderId, String userId, BigDecimal amount,
    ...
    public LegacyPayment fail(String reason) {
    ...
    public boolean equals(Object o) {
        ...
        LegacyPayment payment = (LegacyPayment) o;
